            ...
            <div class="bg-white rounded-xl shadow-2xl max-w-md w-full overflow-hidden" wire:click.stop>
                ...
                <div class="bg-gradient-to-r from-red-500 to-red-600 p-6 text-white">
                    ...
                    <h3 class="text-2xl font-bold text-center">
                        @if(count($orderIdsToCancel) > 1)
                            Remover Item ou Grupo?
                        @else
                            Remover Item?
                        @endif
                    </h3>
                ...
                <div class="p-6">
                    @if($orderToCancelData)
                        <div class="bg-gray-50 rounded-lg p-4 mb-6">
                            ...
                            @if(count($orderIdsToCancel) > 1)
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-gray-600 text-sm">Total no Grupo</span>
                    ...
                    <p class="text-gray-600 text-center mb-6">
                        @if(count($orderIdsToCancel) > 1)
                            Este item faz parte de um grupo. Você deseja remover apenas 1 unidade ou todas as {{ count($orderIdsToCancel) }} unidades?
                        @else
                            Deseja remover este item do pedido? Esta ação não pode ser desfeita.
                        @endif
                    </p>
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="flex gap-3">
                                <button 
                                    ...
                                    Remover Todos ({{ count($orderIdsToCancel) }})
                                </button>
                                <button 
