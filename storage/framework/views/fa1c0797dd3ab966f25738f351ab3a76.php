<div class="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" wire:click="close">
    <div class="bg-white rounded-xl shadow-2xl max-w-md w-full p-6" @click.stop>
        ...
        <div class="space-y-4">
            ...
            <div class="space-y-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tables->whereIn('id', $selectedTables); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="flex items-center p-3 border rounded-lg cursor-pointer transition <?php echo e($mergeDestinationTableId == $table->id ? 'bg-orange-50 border-orange-500 ring-2 ring-orange-200' : 'border-gray-300 hover:border-orange-400'); ?>">
                        <input type="radio" wire:model="mergeDestinationTableId" value="<?php echo e($table->id); ?>" class="h-4 w-4 text-orange-600 border-gray-300 focus:ring-orange-500">
...
<?php /**PATH E:\Projects\solpraia\resources\views/livewire/merge-tables.blade.php ENDPATH**/ ?>